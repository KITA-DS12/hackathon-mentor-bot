      ...
      fields: [
        {
          ...
          label: '何をやろうとしているか',
          type: 'textarea',
          placeholder: '例：ログイン画面でsubmitボタンを押したらユーザー情報を送信したい',
          required: true,
        },
        {
          id: 'what_happened',
          ...
          type: 'textarea',
          placeholder: '例：ボタンを押しても何も起こらない / TypeError: Cannot read property... のエラーが出る',
          required: true,
        },
        {
          id: 'error_message',
          ...
          type: 'textarea',
          placeholder: '例：TypeError: Cannot read property \'id\' of undefined at login.js:25:12',
          required: false,
        },
        {
          id: 'related_code',
    ...
    バックエンド: {
      ...
      fields: [
        ...
        },
        {
          ...
          label: '何が起きているか（現在の状況）',
          type: 'textarea',
          placeholder: '例：500エラーが返る / データベースに保存されない / 認証が通らない',
          required: true,
        },
        {
          id: 'error_message',
          label: 'エラーメッセージ・ログ',
          type: 'textarea',
          placeholder: '例：Error: connect ECONNREFUSED 127.0.0.1:5432 / ValidationError: email is required',
          required: false,
        },
        {
          id: 'related_code',
          label: '関連するコード・設定',
          type: 'textarea',
          placeholder: '例：API エンドポイント、データベーススキーマ、設定ファイルなど',
          required: false,
        },
        {
          id: 'environment',
      ...
      fields: [
        {
          ...
          label: '何をやろうとしているか',
          type: 'textarea',
          placeholder: '例：Next.jsアプリをVercelにデプロイしたい / AWSでデータベースに接続したい',
          required: true,
        },
        {
          id: 'what_happened',
          label: '何が起きているか（現在の状況）',
          type: 'textarea',
          placeholder: '例：Build failed / 404エラーが出る / 環境変数が反映されない',
          required: true,
        },
        {
          id: 'error_message',
          label: 'エラーメッセージ・ログ',
          type: 'textarea',
          placeholder: '例：Error: Command "npm run build" exited with 1 / ENOENT: no such file or directory',
          required: false,
        },
        {
          id: 'related_code',
          ...
          type: 'textarea',
          placeholder: '例：package.json、vercel.json、dockerfile、環境変数設定など',
          required: false,
        },
        {
          id: 'platform',
      ...
      fields: [
        {
          ...
          label: '何をやろうとしているか',
          type: 'textarea',
          placeholder: '例：ヘッダーを画面幅いっぱいに表示したい / グリッドレイアウトで3列に並べたい',
          required: true,
        },
        {
          id: 'what_happened',
          label: '何が起きているか（現在の状況）',
          type: 'textarea',
          placeholder: '例：スマホで崩れる / 要素が重なってしまう / 中央寄せができない',
          required: true,
        },
        {
          id: 'current_css',
        ...
        },
        {
          id: 'css_framework',
          label: '使用しているCSS技術',
          placeholder: '例：Tailwind CSS、Bootstrap、styled-components、CSS Modules',
          required: false,
        },
      ],
    },
    UI・UX相談: {
      ...
      fields: [
        ...
        },
        {
          ...
          label: '気になっている点・課題',
          type: 'textarea',
          placeholder: '例：使いにくそう / 分かりにくい / どっちのデザインがいいか迷う',
          required: true,
        },
        {
          id: 'target_user',
      ...
      fields: [
        {
          ...
          label: 'アイデアの概要',
          type: 'textarea',
          placeholder: '例：学生向けの課題共有アプリ / 地域のイベント情報を集約するサービス',
          required: true,
        },
        {
          id: 'target_users',
        ...
        },
        {
          ...
          label: 'どんな課題を解決したいか',
          type: 'textarea',
          placeholder: '例：課題の締切管理が大変 / イベント情報が分散していて探しにくい',
          required: true,
        },
        {
          id: 'what_want_advice',
          label: 'どんなアドバイスが欲しいか',
          type: 'textarea',
          placeholder: '例：実現可能性、改善点、技術選択、マネタイズ、競合分析など',
          required: true,
        },
        {
          id: 'current_plan',
      ...
      fields: [
        {
          ...
          label: '相談内容',
          type: 'textarea',
          placeholder: '例：チーム運営について / 発表資料の作り方 / プレゼンのコツ / その他何でも',
          required: true,
        },
        {
          id: 'background',
      ...
      fields: [
        {
          ...
          label: '何が起きているか',
          type: 'textarea',
          placeholder: '例：アプリが動かなくなった / 画面が真っ白になる / データが消えた',
          required: true,
        },
        {
          id: 'when_happened',
          ...
          type: 'textarea',
          placeholder: '例：さっきまで動いていた / ライブラリを追加した後 / デプロイしてから',
          required: true,
        },
        {
          id: 'error_message',
          label: 'エラーメッセージ・ログ',
          type: 'textarea',
          placeholder: '例：コンソールエラー、ターミナルのエラー、画面に表示されるエラーなど',
          required: false,
        },
        {
          id: 'environment',
