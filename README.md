...
### 必須項目（投稿方法により異なる）
- **`/mentor-free`**: 質問内容のみ（その他すべて任意）
- **`/mentor-help-simple`**: 質問内容のみ必須、カテゴリ・緊急度・相談方法は任意
- **`/mentor-help`**: テンプレート式で詳細項目あり
...
### Slash Commands
- `/mentor-help` - テンプレート式詳細質問フォーム
- `/mentor-help-simple` - シンプル質問フォーム
- `/mentor-free` - 完全自由投稿
...
### 質問者の使い方
1. **質問作成**: 
   - `/mentor-free` - 自由投稿（最も簡単）
   - `/mentor-help-simple` - シンプルフォーム
   - `/mentor-help` - 詳細テンプレートフォーム
2. **内容入力**: 必要項目を入力して送信
